      ...
      <div class="col-12">
        <div class="card my-4">
          ...
          @can('create_post')
            ...
            <a href="{{route('admin.posts.create')}}" style="float: left;" class="text-secondary font-weight-bold text-xs" >
          ...
          @endcan
            ...
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
              <h6 style="padding-right: 1rem !important;" class="text-white text-capitalize ps-3">جدول المنشورات</h6>
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-secondary text-lg font-weight-bolder opacity-7 ps-2">الاسم</th>
                    <th class="text-center text-uppercase text-secondary text-lg font-weight-bolder opacity-7"> ملاحظات</th>
          ...
          @can('delete_post')
                      ...
                      <a href="{{route('admin.posts.delete',$post->id)}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
