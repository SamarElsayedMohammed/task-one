        ...
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
             @can('create_user')
              <a href="{{route('admin.users.create')}}" style="float: left;" class="text-secondary font-weight-bold text-xs" >
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    @can('delete_user')
                      ...
                      <a href="{{route('admin.users.delete',$user->id)}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
